...
jQuery(document)
    ...
    function () {
        ...
        jQuery.i18n.load("sl", {
            "Funding code:": "Koda projekta:",
            "Project name:": "Ime projekta:",
            "used by %s submission(s)": "se uporablja v %s vnosih",
            "ISO:": "Koda",
            "Language:": "Jezik",
            "used by #%s": "se uporablja %s&times;",
            "Please refer to the submission above for the latest available data. If you nevertheless need the original data, please click ":
              "Najnovejše dostopne podatke najdete v zgornjem vnosu. Če vseeno potrebujete izvorne podatke, prosim kliknite  ",
            "here": "sem",
